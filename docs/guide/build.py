...
PAGES = [
    ...
    ('home-assistant', 'Maison, Spotify et Sonos', 'Modèles et connexions'),
    ('services', 'GitHub, YouTube, Twitch et devises', 'Modèles et connexions'),
    ('mac', 'Statistiques et commandes du Mac', 'Modèles et connexions'),
